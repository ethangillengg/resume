...
\begin{center}
    ...
    \href{mailto:ethan.gill@ucalgary.ca}{\raisebox{-0.2\height}\faEnvelope\  \underline{ethan.gill@ucalgary.ca}} ~ 
    \href{https://www.linkedin.com/in/ethan-gill-008a00258/}{\raisebox{-0.2\height}\faLinkedin\ \underline{Ethan Gill}}  ~
    \href{https://github.com/ethangillengg}{\raisebox{-0.2\height}\faGithub\ \underline{ethangillengg}}
    \vspace{-4pt}
\end{center}
...
\begin{itemize}[leftmargin=0.15in, label={}, parsep=2pt]
    \resumeItem{\textbf{Languages:} TypeScript, C\#, Python, C++, Rust, Nix, Lua}
    \resumeItem{\textbf{Frameworks:} .NET, Node, React, Vue.js, Next.js, Django}
    \resumeItem{\textbf{Tools:} Git, Neovim, LSP, Docker, Nix, CLI}
...
\resumeSubheading
    ...
    \resumeItemListStart
        ...
        \resumeItem{Gained experience with developer processes (\textbf{AGILE}) and proper \textbf{git} procedures.}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \vspace{-13pt}
          \resumeProjectHeading
          {\textbf{Solar Orrery} $|$ \emph{C++, Vulkan}}{Fall 2023}
          \resumeItemListStart
          ...
          \vspace{-13pt}
          \resumeProjectHeading
          {\textbf{\href{https://github.com/ethangillengg/worm-rs}{Worm-rs}} $|$ \emph{Rust, CLI}}{Fall 2023}
          \resumeItemListStart
