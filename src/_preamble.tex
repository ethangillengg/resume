...
\pagecolor{base01} % background
\color{base06}     % text/bullets
% change bold color
\let\oldtextbf\textbf
\renewcommand{\textbf}[1]{\textcolor{base07}{\oldtextbf{#1}}}
...
}{}{0em}{}[\color{base06}\titlerule \vspace{-5pt}]
...
\newcommand{\skillstars}[1]{%
	\foreach \x in {1,...,5}{%
			\ifnum #1<\x
				{\color{base03}\faStar}% Empty stars from the skill level to 5
			\else
