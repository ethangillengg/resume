...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
	\resumeItem{\textbf{Languages:} \Csharp, TypeScript, Java, SQL, Python, \Cpp, C, Bash}
	\resumeItem{\textbf{Frameworks:} .NET 8, Vue.js, Entity Framework, Angular, ASP.NET, React}
	\resumeItem{\textbf{Tools:} Git, SQL Server, Docker, OpenAPI}
	\resumeItem{\textbf{Concepts:} API Structure, Database Design, State Management, Performance Optimization}
