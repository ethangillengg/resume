...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
	\resumeItem{\textbf{Languages:} TypeScript, \Csharp, Go, SQL, Python, \Cpp, Bash}
	\resumeItem{\textbf{Frameworks:} .NET 8, React, Node.js, Express, ASP.NET, Angular, Vue.js}
		\resumeItem{\textbf{Tools:} Git, SQL Server, SQlite, Docker, AWS, Coreutils (CLI), MongoDB}
	\resumeItem{\textbf{Concepts:} RESTful APIs, Database Design, Performance Optimization}
...
\resumeItemListStart
\resumeItem{Key Coursework: Design Patterns, Web Development, Databases, Data Structures and Algorithms}
\resumeItemListEnd
