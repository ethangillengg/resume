...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
	\resumeItem{\textbf{Languages:} TypeScript, Java, \Csharp, SQL, Python, \Cpp, C, Bash}
	\resumeItem{\textbf{Frameworks:} .NET 8, Vue.js, Vite, React, Node.js}
	\resumeItem{\textbf{Tools:} Git, Docker, OpenAPI, SQL Server}
