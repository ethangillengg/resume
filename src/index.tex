...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
	...
	\resumeItem{\textbf{Frameworks:} .NET, React, Node.js, Vue.js, Django}
		\resumeItem{\textbf{Tools:} Git, SQL Server, Docker, Azure}
	\resumeItem{\textbf{Concepts:} RESTful APIs, Relational Databases, Performance Optimization}
...
\resumeItemListStart
\resumeItem{Architected and implemented a \textbf{business-critical} accounting application, using \textbf{.NET Core} to track and calculate investor balances and transactions.}
\resumeItem{Onboarded and mentored new team members, enuring best practices and standards were followed.}
\resumeItem{Designed \textbf{CI/CD} pipelines, and infrastructure in \textbf{Azure}.}
\resumeItem{Scaled development processes and standards \textbf{from zero}, to a team of \textbf{4+} developers.}
\resumeItem{Worked directly with the business to support gather requirements and support existing process.}
\resumeItemListEnd
