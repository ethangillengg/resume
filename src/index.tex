...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
	\resumeItem{\textbf{Languages:} \Csharp, TypeScript, Go, Rust, \Cpp, Nix, Python, Bash}
	\resumeItem{\textbf{Frameworks:} .NET 8, React, Entity Framework, Vite, ASP.NET, Vue.js}
		\resumeItem{\textbf{Tools:} Git, SQL Server, Docker, Linux Coreutils}
	\resumeItem{\textbf{Concepts:} API Structure, Database Design, Performance Optimization}
...
\resumeItemListStart
\resumeItem{Key Coursework: Design Patterns, Web Development, Databases, Operating Systems}
\resumeItemListEnd
